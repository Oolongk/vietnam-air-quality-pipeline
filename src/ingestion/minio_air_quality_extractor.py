...
def chunk_monitoring_points(
    ...
    """
    Chia danh sách monitoring point thành các batch nhỏ.

    Ví dụ:
        10 point, batch_size=3
        -> 4 batch có kích thước 3, 3, 3, 1.
    """
...
def get_open_meteo_batch_size() -> int:
    """
    Đọc kích thước batch từ biến môi trường.

    Giá trị mặc định là 10 monitoring point mỗi request.
    """
